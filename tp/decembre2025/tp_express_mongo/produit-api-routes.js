...
apiRouter.route(['/produit-api/public/produit', '/produit-api/private/produit', '/produit-api/private/role-admin/produit'])
    .post(async function (req, res, next) {
        ...
        try {
            ...
            //let id = savedEntity.code; //saved id (sometimes auto_incr id)
            ...
            res.location('/produit-api/public/produit/' + id).status(201).send(savedEntity);//201: successfully created
        } catch (ex) {
            res.status(statusCodeFromEx(ex)).send(ex);
        }
    });
...
apiRouter.route(['/produit-api/public/produit', '/produit-api/public/produit/:id',
    '/produit-api/private/produit', '/produit-api/private/role-admin/produit/:id','/produit-api/private/produit/:id'])
...
apiRouter.route(['/produit-api/private/produit/:id', '/produit-api/private/role-admin/produit/:id',
     '/produit-api/public/produit/:id'])
